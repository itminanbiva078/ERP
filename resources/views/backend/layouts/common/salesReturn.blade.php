    ...
    <div class="form-row">
      ...
      <div class="form-group row col-md-6 mb-3   div_voucher_no">
         ...
         <div class="col-sm-6">
            ...
            <input type="hidden" name="sale_id" readonly="" class="form-control" id="" placeholder="Voucher No." value="{{$salesList->id}}">
         </div>
      </div>
...
<div class="alert alert-danger">
   <strong>Warning !</strong>Sorry sales return not found!.
 </div>
@endif
