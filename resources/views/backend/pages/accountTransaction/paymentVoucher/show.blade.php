        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @if(helper::roleAccess('accountTransaction.paymentVoucher.create'))
                    <li class="breadcrumb-item"><a href="{{route('accountTransaction.paymentVoucher.create') }}"><i class="fas fa-plus"> Add </i></a></li>
                    @endif
                    @if(helper::roleAccess('accountTransaction.paymentVoucher.index'))
                    <li class="breadcrumb-item"><a href="{{route('accountTransaction.paymentVoucher.index') }}"><i class="fas fa-list">  List</i></a></li>
                    @endif
              ...
              <div class="row no-print">
                <div class="col-md-4">
                  <div class="section-title">
                    <h5><i class="fas fa-file-invoice"></i> Payment Voucher Invoice :</h5>
                  </div>
                </div>
                <div class="col-md-8">
                  ...
                  @if($details->status == "Pending" && helper::roleAccess('accountTransaction.paymentVoucher.accountApproved'))
                  <button type="button" approved_url="{{route("accountTransaction.paymentVoucher.accountApproved",['id' => $details->id,'status' =>"Approved"])}}" class="btn btn-info float-right journal transaction_approved" style="margin-right: 5px;">
                ...
                <div class="col-12 table-responsive">
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      $totalCredit = 0;
                      @endphp
                        @foreach($details->paymentVoucherLedger as $key => $eachLedger)
                          @php 
