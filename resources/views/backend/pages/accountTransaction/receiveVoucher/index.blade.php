        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('accountTransaction.receiveVoucher.create') }}"><i class="fas fa-plus"> Add Voucher</i></a></li>
                    @endif
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                ...
                @if(helper::roleAccess('accountTransaction.receiveVoucher.create'))
                    <a class="btn btn-default" href="{{ route('accountTransaction.receiveVoucher.create') }}"><i class="fas fa-plus"></i>Add New</a>
                    @endif
