            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('accountTransaction.receiveVoucher.index') }}"><i class="fas fa-list">  List</i></a>
                    </li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    @if(helper::roleAccess('accountTransaction.receiveVoucher.index'))
                    <a class="btn btn-default" href="{{ route('accountTransaction.receiveVoucher.index') }}"><i
                            class="fa fa-list"></i>
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form  class="needs-validation" method="POST"  action="{{ route('accountTransaction.receiveVoucher.update',$editInfo->id) }}" novalidate>
                    @csrf
