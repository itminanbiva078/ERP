        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @if(helper::roleAccess('accountTransaction.journalVoucher.index'))
                    <li class="breadcrumb-item"><a
                            href="{{ route('accountTransaction.journalVoucher.index') }}"><i class="fas fa-list">  List</i></a>
                    </li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(helper::roleAccess('accountTransaction.journalVoucher.index'))
                    <a class="btn btn-default" href="{{ route('accountTransaction.journalVoucher.index') }}"><i
                            class="fa fa-list"></i>
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form  class="needs-validation" method="POST"  action="{{ route('accountTransaction.journalVoucher.update',$editInfo->id) }}" novalidate>
                    @csrf
