        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @if(helper::roleAccess('inventoryTransaction.purchases.pendingCheque.index'))
                    <li class="breadcrumb-item"><a href="{{route('inventoryTransaction.purchases.pendingCheque.index') }}"><i class="fas fa-list">  List</i></a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>View Voucher</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="invoice Money-receipt">
      <div class="container-fluid">
          ...
          <div class="col-md-12">
            <div class="Money-receipt-contant">
              <div class="section-title">
                <h3 style="border-bottom: double;"> Payment Voucher </h3>
              </div>
              ...
              <table style="width:100%;">
                <tr> 
                  <td> <span> Received With Thanks From :  </span> {{$details->purchases->supplier->name ?? ''}}</td>
                </tr>
              </table>
              <table style="width:100%;">
                <tr> 
              ...
              <table style="width:100%;">
                <tr> 
                  <td style="width:50%;"> <span> for the purpose of :  </span> {{$details->purchases->voucher_no ?? ''}} </td>
                  <td style="width:50%;"> <span> Contact No:  </span>{{$details->purchases->supplier->phone ?? ''}}   </td>
                </tr>
              </table>
        ...
        <div class="row no-print">
          ...
          @if($details->status == "Pending" && helper::roleAccess('inventoryTransaction.purchases.pendingCheque.approved'))
            <button type="button" approved_url="{{route("inventoryTransaction.purchases.pendingCheque.approved",['id' => $details->id,'status' =>"Approved"])}}" class="btn btn-info float-right journal transaction_approved2" style="margin-right: 5px;">
