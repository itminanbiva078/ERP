        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @if(helper::roleAccess('inventoryTransaction.purchasesPayment.index'))
                    <li class="breadcrumb-item"><a href="{{ route('inventoryTransaction.purchasesPayment.index') }}"><i class="fas fa-list">  List</i></a>  </li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(helper::roleAccess('inventoryTransaction.purchasesPayment.index'))
                    <a class="btn btn-default" href="{{ route('inventoryTransaction.purchasesPayment.index') }}"><i
                            class="fa fa-list"></i>
...
<script>
    $(document).on('change', '.supplier_id', function() {
        ...
        $.ajax({
                ...
                "url": '<?php echo route("inventoryTransaction.purchasesPayment.dueVoucherList"); ?>',
                "dataType": "json",
                "type": "GET",
                "data": {
                    "_token": "<?= csrf_token() ?>",
