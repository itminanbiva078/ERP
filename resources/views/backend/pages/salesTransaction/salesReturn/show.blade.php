        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('salesTransaction.salesReturn.create') }}"><i class="fas fa-plus"> Add </i> </a></li>
                    @endif
                    @if(helper::roleAccess('salesTransaction.salesReturn.index'))
                    <li class="breadcrumb-item"><a href="{{route('salesTransaction.salesReturn.index') }}"><i class="fas fa-list">  List</i> </a></li>
                    @endif
              ...
              <div class="row no-print">
                <div class="col-md-4">
                  <div class="section-title">
                    <h5><i class="fas fa-file-invoice"></i>  Sales Return Invoice:</h5>
                      {{-- This page has been enhanced for printing. Click the print button at the bottom of the invoice to test. --}}
                  </div>
                </div>
                <div class="col-md-8">
                  @if($details->status == "Pending" && helper::roleAccess('salesTransaction.salesReturn.approved'))
                  <button type="button" approved_url="{{route("salesTransaction.salesReturn.approved",['id' => $details->id,'status' =>"Approved"])}}" class="btn btn-info float-right journal transaction_approved" style="margin-right: 5px;">
