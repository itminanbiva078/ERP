...
use helper;
use App\Services\SalesSetup\CustomerMediaService;
use App\Transformers\CustomerMediaTransformer;

class CustomerMediaController extends Controller
{

    /**
     * @var CustomerMediaService
     */
    private $systemService;
    /**
     * @var CustomerMediaTransformer
     */
    private $systemTransformer;

    /**
     * CustomerMediaController constructor.
     * @param CustomerMediaService $systemService
     * @param CustomerMediaTransformer $systemTransformer
     */
    public function __construct(CustomerMediaService $customerMediaService, CustomerMediaTransformer $customerMediaTransformer)
    {
        $this->systemService = $customerMediaService;
        $this->systemTransformer = $customerMediaTransformer;
    }
    ...
    public function dataProcessingCustomerMedia(Request $request)
    {
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('salesSetup.customerMedia.index');
    }
    /**
     * @param $slug
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
    ...
    public function edit($id)
    {
        ...
        $title = "Customer Manage | Edit - Customer Media";
        $listRoute = "salesSetup.customerMedia.index";
        $explodeRoute = "";
        $implodeModal ="";
