        ...
        if ($smpts) {
            foreach ($smpts as $key => $smpt) {
                ...
                if ($smpt->status == 'Approved') :
                    ...
                    $status = '<input  class="status_row" status_route="' . route('settings.smpt.status', [$smpt->id, 'Approved']) . '"  id="toggle-demo" type="checkbox" name="my-checkbox"  data-bootstrap-switch data-off-color="danger" data-on-color="success">';
                endif;
